...
void CGlock::GlockFire(float flSpread, float flCycleTime, bool fUseAutoAim)
{
	...
	PLAYBACK_EVENT_FULL(flags, m_pPlayer->edict(), fUseAutoAim ? m_usFireGlock1 : m_usFireGlock2, 0.0, g_vecZero, g_vecZero, vecDir.x, vecDir.y, 0, fovspread, (m_iClip == 0) ? 1 : 0, 0);
