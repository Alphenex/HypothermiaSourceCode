...
#define BLOOD_COLOR_SYNTHBLUE (byte)47
...
{
	None, // Use default Half Life audio, doesn't support high quality sounds
	Sound, // Has HD Audio, recommended for non-looping audio 10-ish seconds audio.
	Music // Has HD Audio, recommended for looping or non-looping long audio.
};

extern void UTIL_SetOrigin(entvars_t* pev, const Vector& vecOrigin);
extern void UTIL_EmitAmbientSound(edict_t* entity, const Vector& vecOrigin, const char* samp, float vol, float attenuation, int fFlags, int pitch, AudioType type = AudioType::None);
