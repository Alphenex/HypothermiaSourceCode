...
#define RGB_BLUEISH 0x000091ff		//	0,		145,	255
#define RGB_DARKBLUEISH 0x000048ff	//	0,		72,		255

//#define RGB_YELLOWISH 0x00FFA000	//	255,	160,	0
#define RGB_YELLOWISH RGB_BLUEISH	//	255,	160,	0
...
public:
	...
	bool MsgFunc_Audio(const char* pszName, int iSize, void* pbuf);
	bool MsgFunc_Flamespit(const char* pszName, int iSize, void* pbuf);
